...
func (s *MatrixService) RotateMatrix(data [][]int, token string) ([][]int, map[string]interface{}, error) {
	// Validate matrix
	...
	statistics, err := s.nodeAPIService.SendRotatedMatrix(rotatedMatrix, isOriginalDiagonal, token)
	if err != nil {
